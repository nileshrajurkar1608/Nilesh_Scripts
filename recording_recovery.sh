...
echo -e "\e[46;32m\nBelow input will help to create commands to change ownership of mp4 file and command to download mp4 on local PC. You may copy them to use after transcoding completes:\e[0m"
...
echo -e "scp ${USER_NAME}@10.9.130.81:/mnt/data/${REC_ID}_media.mp4 .\n"
